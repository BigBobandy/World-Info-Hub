...
function applyFilters() {
    let filteredCountries = filterCountriesBySearchTerm(allCountries, currentFilters.searchTerm);
    filteredCountries = filterCountriesByRegion(filteredCountries, currentFilters.region);
